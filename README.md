...
> **基金清单配置化（2026-08-26 恢复）**：`config/funds.json` 驱动（可经本地维护面板 github-data-maintainer.html 编辑，或直接改文件提交）。run_daily 的 `load_funds_config()` + render_html 的 `_load_fund_names()` 读取，缺失回退内置默认。**增减基金 → 下次 cron 自动生效**（卡片/走势图/验证/涨跌幅列全自动跟随）。当前 12 只：002891/008254/014002/015202/016702/018147/021277/021842/012922/022184/080006/024239。
